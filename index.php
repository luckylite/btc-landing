...
$phoneNumberCode = $countryArray[$country_code]['code'];
...
<head>
    ...
    <title>BTC Landing</title>

    <link rel="stylesheet" href="css/grid.min.css">
    <link rel="stylesheet" href="css/main.css">

    <script src="https://kit.fontawesome.com/52f827a274.js"></script>
</head>
<body>
    <header class="header">
        <div class="container">
    ...
    <section class="section about-btc">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="feedback_form">
                        <form action="" id="feedback">
                            ...
                            <input type="text" name="phone" placeholder="Моб. телефон" value="+<?php echo $phoneNumberCode; ?>" required>
                            <input type="text" name="country" placeholder="Страна проживания" value="<?php echo $country; ?>" required>
							<button type="submit">Оставить заявку</i></button>
